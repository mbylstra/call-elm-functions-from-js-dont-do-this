...
Elm.PureElmExamples = Elm.PureElmExamples || {};
Elm.PureElmExamples.make = function (_elm) {
   "use strict";
   _elm.PureElmExamples = _elm.PureElmExamples || {};
   if (_elm.PureElmExamples.values)
   return _elm.PureElmExamples.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var listReverse = function (xs) {
      return A3($List.foldl,
      F2(function (x,acc) {
         return A2($Basics._op["++"],_U.list([x]),acc);
      }),
      _U.list([]),
      xs);
   };
   var stringReverse = function (s) {
      return $String.fromList(listReverse($String.toList(s)));
   };
   var add = F2(function (a,b) {    return a + b;});
   return _elm.PureElmExamples.values = {_op: _op
                                        ,add: add
